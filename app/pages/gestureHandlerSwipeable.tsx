// from https://github.com/software-mansion/react-native-gesture-handler/tree/main/example/src/showcase/swipeable

import React from 'react';
import { StyleSheet, Text, View, I18nManager } from 'react-native';
import { FlatList, RectButton } from 'react-native-gesture-handler';
import AppleStyleSwipeableRow from '../components/swipeable-rows/appleStyleSwipeableRow';
import GmailStyleSwipeableRow from '../components/swipeable-rows/gmailStyleSwipeableRow';
...
export default function GestureHandlerSwipeable() {
    return (
        <FlatList
        data={DATA}
